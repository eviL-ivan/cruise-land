...
const baseContent = {
  ...
  thankYou: {
    ...
    shipBrochureDescription: "View ship information",
  ...
  forms: {
    ...
    contact: {
      ...
      comments: "Comment",
      isTravelAgent: "I'm Travel Agent",
      consent: "I confirm that my personal data may be used for contractual processing and further information about the products and services offered by Swan Hellenic",
      consentRequired: "I confirm that my personal data may be used for contractual processing and further information about the products and services offered by Swan Hellenic *",
      submit: "Begin Your Journey",
      submitting: "Sending...",
      success: "Thank You!",
      successMessage: "Your inquiry has been successfully submitted. We'll contact you soon.",
