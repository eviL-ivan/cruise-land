...
const baseContent = {
  ...
  forms: {
    ...
    contact: {
      ...
      comments: "备注",
      isTravelAgent: "我是旅行社代理",
      consent: "我确认我的个人数据可用于合同处理以及 Swan Hellenic 提供的产品和服务的进一步信息",
      consentRequired: "我确认我的个人数据可用于合同处理以及 Swan Hellenic 提供的产品和服务的进一步信息 *",
      submit: "开启您的旅程",
      submitting: "发送中...",
      success: "谢谢！",
      successMessage: "您的咨询已成功提交。我们会尽快与您联系。",
      emailError: "请输入有效的电子邮箱地址",
      phoneError: "请输入有效的电话号码",
      errorSubmitting: "提交表单时出错。请重试。",
    },
  },
} as const;
