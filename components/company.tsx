        ...
        >
          <div>
            ...
            <div className="space-y-6">
              <h2 className="font-serif text-4xl md:text-5xl lg:text-5xl font-light leading-tight text-balance text-[#004155]">
                Swan Hellenic
              </h2>

              <p className="font-serif text-3xl md:text-4xl lg:text-4xl leading-relaxed text-[#004155] italic">
                {content.company.title}
              </p>

              <p className="text-sm lg:text-base leading-relaxed text-[#004155]">
              ...
              <div className="border-l-2 border-[#004155]/30 pl-4">
                <p className="font-serif text-lg lg:text-xl text-[#004155] italic">
